...
if __name__ == '__main__':
    ...
    for filename in args.filenames:
        ...
        reducedIm, reducedEnergyImage = reduce_width_by(im, energyImage, args.energy_function, args.n_pixels)
        if args.ef_in_out:
            mpimg.imsave('outputReduceWidth_{}_{}.png'.format(args.energy_function, filename), reducedIm)
        else:
            mpimg.imsave('outputReduceWidth{}.png'.format(filename), reducedIm)
